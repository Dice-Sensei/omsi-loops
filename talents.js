...
const talents = {
  ...
  spendablePoints() {
    return this.totalPoints() - playerTalents.spentPoints;
  },
  1: {
    name() {
      return _txt('talents>calculated_shattering>name');
    },
    desc() {
      return _txt('talents>calculated_shattering>desc');
    },
    cost: 1,
    points: 0,
    maxPoints: 5,
  ...
  2: {
    name() {
      return _txt('talents>no_frill_frames');
    },
    desc() {
      return _txt('talents>no_frill_frames>desc');
    },
    cost: 1,
    points: 0,
    maxPoints: 2,
