        ...
        <div>
          ...
          <div>
            ...
            >
              ...
              <div
                class='stat-pie mask'
                style='background:conic-gradient(from 0.35turn,var(--stat-Cha-color) calc(0.35turn * var(--pie-ratio)),var(--stat-Spd-color) calc(0.5turn - (0.15turn * var(--pie-ratio))) calc(0.5turn + (0.15turn * var(--pie-ratio))),var(--stat-Cha-color) calc(1turn - (0.35turn * var(--pie-ratio))))'
              >
              </div>
              <div class='showthis when-unlocked' draggable='false'>
                That's not fair. There was time now. There was all the time I needed.Now you have to get new glasses
                again for 10 gold!Causes Wander to be 4x as effective for the rest of the loop.Affects any action with
                the glasses iconCan only have 1 Buy Glasses action.Unlocked at 20% explored.
                ...
                <div class='bold'>Exp Multiplier:</div>
                <div id='expMultBuyGlasses'>100</div>%
              </div>
              <div class='showthis when-locked' draggable='false'>
                That's not fair. There was time now. There was all the time I needed.Now you have to get new glasses
                again for 10 gold!Causes Wander to be 4x as effective for the rest of the loop.Affects any action with
          ...
          <div>
            <button
              id='containerFoundGlasses'
              class='actionContainer actionOrTravelContainer normalActionContainer showthat capped hidden'
              draggable='true'
            >
              <label>Found Glasses</label>
              <div style='position:relative'>
                <img src='icons/foundGlasses.svg' class='superLargeIcon' draggable='false' />
                <img
              ...
              <div class='showthis when-unlocked' draggable='false'>
                You could have sworn you had a spare pair of glasses somewhere. Now you've explored to the ends of the
                world. Every nook and cranny has revealed to you their secrets. And you've found them - in the last
                place anyone would ever think to look: on top of your head.You now start all loops with glasses.
          ...
          <div>
            ...
            >
              ...
              <div class='showthis when-unlocked' draggable='false'>
                1 gold =
                <span id='goldCostBuyManaZ1'>50</span>
                ...
                <div class='bold'>Exp Multiplier:</div>
                <div id='expMultBuyManaZ1'>100</div>%
              </div>
              <div class='showthis when-locked' draggable='false'>
                1 gold =
          ...
          <div>
            ...
            >
              ...
              <div
                class='stat-pie mask'
                style='background:conic-gradient(from 0.4turn,var(--stat-Cha-color) calc(0.4turn * var(--pie-ratio)),var(--stat-Int-color) calc(0.45000000000000007turn - (0.05turn * var(--pie-ratio))) calc(0.45000000000000007turn + (0.05turn * var(--pie-ratio))),var(--stat-Soul-color) calc(0.5499999999999999turn - (0.05turn * var(--pie-ratio))) calc(0.5499999999999999turn + (0.05turn * var(--pie-ratio))),var(--stat-Cha-color) calc(1turn - (0.4turn * var(--pie-ratio))))'
              >
              </div>
              <div class='showthis when-unlocked' draggable='false'>
                They won't let you get away with a simple chat.Unlocked at 22% Explored.
          ...
          <div>
            ...
            >
              ...
              <div
                class='stat-pie mask'
                style='background:conic-gradient(from 0.15turn,var(--stat-Cha-color) calc(0.15turn * var(--pie-ratio)),var(--stat-Str-color) calc(0.25turn - (0.1turn * var(--pie-ratio))) calc(0.25turn + (0.1turn * var(--pie-ratio))),var(--stat-Spd-color) calc(0.44999999999999996turn - (0.1turn * var(--pie-ratio))) calc(0.44999999999999996turn + (0.1turn * var(--pie-ratio))),var(--stat-Dex-color) calc(0.6turn - (0.05turn * var(--pie-ratio))) calc(0.6turn + (0.05turn * var(--pie-ratio))),var(--stat-Luck-color) calc(0.6999999999999998turn - (0.05turn * var(--pie-ratio))) calc(0.6999999999999998turn + (0.05turn * var(--pie-ratio))),var(--stat-Soul-color) calc(0.7999999999999999turn - (0.05turn * var(--pie-ratio))) calc(0.7999999999999999turn + (0.05turn * var(--pie-ratio))),var(--stat-Cha-color) calc(1turn - (0.15turn * var(--pie-ratio))))'
              >
              </div>
              <div class='showthis when-unlocked' draggable='false'>
                Be a hero! ...If the reward is good and it doesn't take too long.Short Quests with loot give
                <span id='goldCostSQuests'>20</span>
              ...
              <div class='showthis when-locked' draggable='false'>
                ...
                (<span class='bold stat-Cha stat-color'>Cha</span>, <span class=' stat-Str stat-color'>Str</span>,
                <span class=' stat-Spd stat-color'>Spd</span>, <span class=' stat-Dex stat-color'>Dex</span>,
          ...
          <div>
            ...
            >
              ...
              <div
                class='stat-pie mask'
                style='background:conic-gradient(from 0.2turn,var(--stat-Cha-color) calc(0.2turn * var(--pie-ratio)),var(--stat-Per-color) calc(0.35000000000000003turn - (0.15turn * var(--pie-ratio))) calc(0.35000000000000003turn + (0.15turn * var(--pie-ratio))),var(--stat-Spd-color) calc(0.5999999999999999turn - (0.1turn * var(--pie-ratio))) calc(0.5999999999999999turn + (0.1turn * var(--pie-ratio))),var(--stat-Luck-color) calc(0.75turn - (0.05turn * var(--pie-ratio))) calc(0.75turn + (0.05turn * var(--pie-ratio))),var(--stat-Cha-color) calc(1turn - (0.2turn * var(--pie-ratio))))'
              >
              </div>
              <div class='showthis when-unlocked' draggable='false'>
                You've been hearing some rumors...Unlocked at 25% People Met.
          ...
          <div>
            ...
            >
              ...
              <div
                class='stat-pie mask'
                style='background:conic-gradient(from 0.2turn,var(--stat-Con-color) calc(0.2turn * var(--pie-ratio)),var(--stat-Str-color) calc(0.3turn - (0.1turn * var(--pie-ratio))) calc(0.3turn + (0.1turn * var(--pie-ratio))),var(--stat-Spd-color) calc(0.5turn - (0.1turn * var(--pie-ratio))) calc(0.5turn + (0.1turn * var(--pie-ratio))),var(--stat-Int-color) calc(0.7turn - (0.1turn * var(--pie-ratio))) calc(0.7turn + (0.1turn * var(--pie-ratio))),var(--stat-Con-color) calc(1turn - (0.2turn * var(--pie-ratio))))'
              >
              </div>
              <div class='showthis when-unlocked' draggable='false'>
                Be a more impressive hero! ...As long as someone is watching.Long Quests with loot give
                <span id='goldCostLQuests'>30</span>
          ...
          <div>
            ...
            >
              ...
              <div
                class='stat-pie mask'
                style='background:conic-gradient(from 0.4turn,var(--stat-Cha-color) calc(0.4turn * var(--pie-ratio)),var(--stat-Soul-color) calc(0.5turn - (0.1turn * var(--pie-ratio))) calc(0.5turn + (0.1turn * var(--pie-ratio))),var(--stat-Cha-color) calc(1turn - (0.4turn * var(--pie-ratio))))'
              >
              </div>
              <div class='showthis when-unlocked' draggable='false'>
                Take a break and socialize.Gives people met progress equivalent to 16 Meet People actions.Costs 2
                reputation.Unlocked at 30% Investigated.
                ...
                <div class='bold'>Exp Multiplier:</div>
                <div id='expMultThrowParty'>200</div>%
              </div>
              <div class='showthis when-locked' draggable='false'>
                Take a break and socialize.Gives people met progress equivalent to 16 Meet People actions.Costs 2
                reputation.Unlocked at 30% Investigated.

                (<span class='bold stat-Cha stat-color'>Cha</span>, <span class=' stat-Soul stat-color'>Soul</span>)
              </div>
            </button>
          </div>
          <div>
          ...
          <div>
            ...
            >
              ...
              <div class='showthis when-unlocked' draggable='false'>
                Prepare to move on.Costs <div id='suppliesCost'></div>
                gold.You only need one set of supplies.Unlocked at a combined Combat and Magic skill of 35.
                ...
                <div class='bold'>Exp Multiplier:</div>
                <div id='expMultBuySupplies'>100</div>%
              </div>
              <div class='showthis when-locked' draggable='false'>
                Prepare to move on.Costs <div id='suppliesCost'></div>
                gold.You only need one set of supplies.Unlocked at a combined Combat and Magic skill of 35.
          ...
          <div>
            ...
            >
              ...
              <div class='showthis when-unlocked' draggable='false'>
                They won't like you as much, but hey - you're leaving.Costs 1 reputation to reduce the price of supplies
                by 20. Unlocked at a combined Combat and Magic skill of 35.
        ...
        <div>
          <div>
            ...
            >
              ...
              <div class='showthis when-unlocked' draggable='false'>
                Follow the trail to end up at the next town. You need to keep moving until you can learn how to shut
                these loops off.Costs 1 supplies. Finish once to unlock Forest Path's actions, then finish this in order
                to use Forest Path's actions.Unlocked at a combined Combat and Magic skill of 35.
                ...
                <div class='bold'>Exp Multiplier:</div>
                <div id='expMultStartJourney'>200</div>%
              </div>
              <div class='showthis when-locked' draggable='false'>
                Follow the trail to end up at the next town. You need to keep moving until you can learn how to shut
                these loops off.Costs 1 supplies. Finish once to unlock Forest Path's actions, then finish this in order
          ...
          <div>
            ...
            >
              ...
              <div class='showthis when-unlocked' draggable='false'>
                The Explorers' guild has a contract with various caravans for transport around the world. They have
                taught you the secret handsigns to gain passage. And this one just happens to have some spare mana to
                share on the journey! Unlocked with 25% of the world surveyed. Travels to Merchanton.
                ...
                <div class='bold'>Exp Multiplier:</div>
                <div id='expMultHitchRide'>100</div>%
              </div>
              <div class='showthis when-locked' draggable='false'>
                The Explorers' guild has a contract with various caravans for transport around the world. They have
                taught you the secret handsigns to gain passage. And this one just happens to have some spare mana to
