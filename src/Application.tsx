...
import { VersionChange } from './locales/translations.en.ts';
...
enum Menu {
  ...
  Totals = 'totals',
  PrestigeBonus = 'prestige_bonus',
}

const [disabledMenus, setDisabledMenus] = createSignal<Set<Menu>>(new Set());
const toggleMenu = (menu: Menu, value: boolean) => {
  const menus = new Set(disabledMenus());
...
const VersionOption = (props: VersionOptionProps) => (
...
const MenuManagmentOption = () => {
  return (
    <li class='w-8 h-8 showthatH'>
      <span>O</span>
      <div class='showthisH'>
        <span class='font-medium'>{t('menu.enable.title')}</span>
        <CheckboxField onChange={(value) => toggleMenu(Menu.Changelog, value)} value={true}>
          {t('menu.changelog.title')}
        </CheckboxField>
        <CheckboxField onChange={(value) => toggleMenu(Menu.Save, value)} value={true}>
          {t('menu.save.title')}
        </CheckboxField>
        <CheckboxField onChange={(value) => toggleMenu(Menu.Faq, value)} value={true}>
          {t('menu.faq.title')}
        </CheckboxField>
        <CheckboxField onChange={(value) => toggleMenu(Menu.Options, value)} value={true}>
          {t('menu.options.title')}
        </CheckboxField>
        <CheckboxField onChange={(value) => toggleMenu(Menu.Extras, value)} value={true}>
          {t('menu.extras.title')}
        </CheckboxField>
        <CheckboxField onChange={(value) => toggleMenu(Menu.Challenges, value)} value={true}>
          {t('menu.challenges.title')}
        </CheckboxField>
        <CheckboxField onChange={(value) => toggleMenu(Menu.Totals, value)} value={true}>
          {t('menu.totals.title')}
        </CheckboxField>
        <CheckboxField onChange={(value) => toggleMenu(Menu.PrestigeBonus, value)} value={true}>
...
const MenuFaqOption = () => {
  return (
    <li class='showthatH'>
      {t('menu.faq.title')}
      <ul class='flex flex-col gap-1 showthisH'>
